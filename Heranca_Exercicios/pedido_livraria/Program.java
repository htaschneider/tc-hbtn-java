...
public class Program {
  public static void main(String[] args) {
    ...
    produtos.Livro livro2 = new produtos.Livro("Um de nós está mentindo", 2018, "Brasil", 34.93, 384, "Karen Mcmanus",
        1);
    produtos.Livro livro3 = new produtos.Livro("Mindset Milionário", 2021, "Brasil", 31.70, 272, "José Roberto Marques",
        1);
